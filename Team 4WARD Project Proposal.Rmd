...
Prospective MBAn students are not knowledgeable about how to communicate effectively in the corporate world. It is difficult for them to adapt to the team-cooperating environment of the MBAn program and further to their careers. Also, they have few ideas about the available team management software and tools which can make their lives easier.
...
1. Interview Questions to ask current MBAn students and industry professionals 

2. Conduct Interviews and Gather data 

3. Take that data and use the information to create different pages that provides information about how to communicate effectively and collaborate effectively in industry and in the MBAn program 
