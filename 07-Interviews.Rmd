...
In this case one will evaluate the potential of opening a coffee shop, performing market sizing and financial analyses.

BCG - [Chateau Boomerang](https://mconsultingprep.com/case-interview-examples/)

In this case one will create a 3-5 page slide deck in which they examine the U.S wine market for an Australian producer.

Deloitte - [Technology Implementation Strategy](https://caseinterviewprep.deloitte.com/cases/apa/ug/1)

In this case one will recommend a strategy in implementing a new driving technology, focusing on how risk will be mitigated and how to maximize the impact of the technology

Deloitte - [Federal Health Agency](https://caseinterviewprep.deloitte.com/cases/strategy/adv/2)

In this case one is tasked with managing a $1 billion Ebola emergency fund, creating a draft of how the money should be properly divided and used.

Accenture - [Case Interview Workbook](https://caseinterviewprep.deloitte.com/cases/strategy/adv/2)

This workbook breaks down how one should approach a case study, giving multiple sample frameworks and practice cases.
...
NOTE: One should be prepared to demonstrate skills in programming and coding languages such as Python R, etc. and be able to answer questions regarding SQL, Tableau, and Excel. Be prepared for a live examination of skills.  
...
### The STAR Method
The STAR Method
When answering behavioral questions, or any other story-based questions, one should always respond using the STAR method. The STAR method follows is an interview technique in which one lays out the Situation, Task, Action, and Result of a story, giving an interviewer a digestible, yet complete, vision of what one accomplished. One should keep their answers concise, aiming for one to two sentences per letter; however, the most focus should be placed on the Action and Result sections. 
